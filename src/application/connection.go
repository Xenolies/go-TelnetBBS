...
func NewConnection(server inface.IServer, conn *net.TCPConn, connID uint32, msgHandler inface.IMsgHandler) *Connection {
	c := &Connection{
		TcpServer: server,
		Conn:      conn,
		ConnID:    connID,
